                        ...
                        <div class="card card-form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-cols-3 mb-3">
                                    <div class="col">
                                        ...
                                        <div class="custom-switch">
                                            <input type="checkbox" name="is_active" id="is_active" @checked(old('is_active'))>
                                            <label for="is_active">
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="about" name="about" style="height: 100px">{{ old('about') }}</textarea>
